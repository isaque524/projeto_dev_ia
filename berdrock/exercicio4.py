...
def chamar_bedrock(mensagem: str) -> dict:
    ...
    user_message = f"Estou tendo o seguinte problema: {mensagem}. Por favor, me explique em português o que pode ter ocorrido, pois preciso dessa explicação em português."
